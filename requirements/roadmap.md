...
- Native iOS remains a separate iPhone app track under `ios-native/`.
- Plan future native slices from the current product gaps and current repo state rather than from retained bundle history.
