...
Goal:
- Address actionable issues found during review or testing for the native iOS History and summary parity slice.

Rules:
- Stay within the original slice scope.
- Do not widen into sync, Home parity, or larger codebase cleanup unless the issue proves it is necessary.
