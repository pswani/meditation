...
2. implement the critical and important UX improvements from docs/ux-review-custom-plays.md
3. keep scope bounded to:
   - Custom Plays
...
10. commit with a clear message:
   feat(ux): refine custom plays and manual logging experience
