...
Goal:
- Address actionable issues found during review or testing for the native iOS `custom play` and playlist milestone.

Rules:
- Stay within the original milestone scope.
- Do not widen into summary, `sankalpa`, or backend sync work.
