...
Goal:
- Address actionable issues found during review or testing for the native iOS Home parity slice.

Rules:
- Stay within the original slice scope.
- Do not widen into sync, media-model changes, or larger architectural cleanup unless the issue proves it is necessary.
