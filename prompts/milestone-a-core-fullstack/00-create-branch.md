...
2. Treat the current branch as the parent branch for this Milestone A.
3. Create a new local branch for this Milestone A work from the current branch.
4. Use a clear branch name in this format if available:
   - `codex/prompts/milestone-a-core-fullstack`
...
10. Commit documentation-only changes if any were made, with a clear message such as:
   chore(branch): prepare local branch for Milestone A
