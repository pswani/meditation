...
2. Treat the current branch as the parent branch for this Milestone D.
3. Create a new local branch for this Milestone D work from the current branch.
...
10. Commit documentation-only changes if any were made, with a clear message such as:
   chore(branch): prepare local branch for Milestone D
