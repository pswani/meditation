...
Goal:
- Address actionable issues found during review or testing for the native iOS `custom play` parity slice.

Rules:
- Stay within the original slice scope.
- Do not widen into sync, Home parity, or broader History or summary work unless the issue proves it is necessary.
